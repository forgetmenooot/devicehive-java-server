 ...
 * 05.02.16.
 */
public class RabbitCommandConsumer implements IRabbitConsumer<DeviceCommand> {

    private static final Logger logger = LoggerFactory.getLogger(RabbitCommandConsumer.class);
